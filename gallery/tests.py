...
class Image_test(TestCase):
    """
    image class to test image model class functionality
    Args:
    TestCase: unittest module class to create the tests
    """
    def setUp(self):
        ...
        self.image_test = Image(id=1, name='image', description='A test image', location=self.location,
...
class Test_location(TestCase):
    ...
    def test_update_location(self):
        ...
        changed_location = Location.objects.filter(name='meru')
...
class Category_test_class(TestCase):
    """
